...
public class AdapterLoop extends BaseAdapter {
    ...
    public AdapterLoop(Context context){
        this.context = context;
        mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    }

    public int getCount() {
        return HamaApp.DEV_GROUP.getLoopHolder().getListLinkage().size();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Linkage linkage = HamaApp.DEV_GROUP.getLoopHolder().getListLinkage().get(position);
        if (convertView == null){
    ...
    private static class ViewHolder {
        ...
        CompoundButton.OnCheckedChangeListener onCheckedChangeListener = new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                LinkageDao.get(context).update(linkage, null);
            }
        };
    }
}