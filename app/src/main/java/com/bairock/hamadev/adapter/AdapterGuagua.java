...
public class AdapterGuagua extends BaseAdapter {
    ...
    public AdapterGuagua(Context context){
    ...
    @Override
    public int getCount() {
        return HamaApp.DEV_GROUP.getGuaguaHolder().getListLinkage().size();
    }

    @Override
    public Object getItem(int position) {
        return HamaApp.DEV_GROUP.getGuaguaHolder().getListLinkage().get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Linkage linkage = HamaApp.DEV_GROUP.getGuaguaHolder().getListLinkage().get(position);
        if (convertView == null){
