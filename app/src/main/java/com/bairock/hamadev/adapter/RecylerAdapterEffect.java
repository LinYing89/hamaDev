...
public class RecylerAdapterEffect extends RecyclerView.Adapter<RecylerAdapterEffect.ViewHolder> {

    private LayoutInflater mInflater;
    private List<Effect> listEffect;
    private boolean showSwitch;

    public RecylerAdapterEffect(Context context, List<Effect> listEffect, boolean showSwitch) {
    ...
    @NonNull
    @Override
    public RecylerAdapterEffect.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new RecylerAdapterEffect.ViewHolder(mInflater.inflate(R.layout.adapter_list_effect, parent, false), showSwitch);
    }

    @Override
    public void onBindViewHolder(@NonNull RecylerAdapterEffect.ViewHolder holder, int position) {
